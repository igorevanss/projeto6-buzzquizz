...
function questionURLValidation() {
  ...
  for (let i = 0; i < allMaxi.length; i++) {
    while (cont < questionObject[i].answers.length) {
      if (
        pattern.test(allMaxi[i].querySelectorAll('.url')[cont].value) ||
        allMaxi[i].querySelectorAll('.url')[cont].value !== ''
      ) {
        allMaxi[i]
        ...
        allMaxi[i]
          .querySelectorAll('.url')
          [cont].nextElementSibling.classList.remove('validation')
        allMaxi[i]
          .querySelectorAll('.url')
          [cont].classList.remove('invalidInput')
      } else {
        allMaxi[i]
          .querySelectorAll('.url')
        ...
        allMaxi[i]
          .querySelectorAll('.url')
          [cont].nextElementSibling.classList.add('validation')
  ...
  for (let i = 0; i < allMaxi.length; i++) {
    while (cont < questionObject[i].answers.length) {
      if (allMaxi[i].querySelectorAll('.answer')[cont].value !== '') {
        ...
        allMaxi[i]
          .querySelectorAll('.answer')
          [cont].classList.add('invalidInput')
      }
      cont++
    }
    cont = 0
